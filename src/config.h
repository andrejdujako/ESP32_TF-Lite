#ifndef TENSORFLOW_LITE_MKD_MONEY_RECOGNITION_CONFIG_H_
#define TENSORFLOW_LITE_MKD_MONEY_RECOGNITION_CONFIG_H_
...
#endif  // TENSORFLOW_LITE_MKD_MONEY_RECOGNITION_CONFIG_H_
