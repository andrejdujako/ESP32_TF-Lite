#ifndef TENSORFLOW_LITE_MKD_MONEY_RECOGNITION_IMAGE_PROVIDER_H_
#define TENSORFLOW_LITE_MKD_MONEY_RECOGNITION_IMAGE_PROVIDER_H_
...
#endif  // TENSORFLOW_LITE_MKD_MONEY_RECOGNITION_IMAGE_PROVIDER_H_
